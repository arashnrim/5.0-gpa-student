...
export const TEXT_GENERATION_ERROR_STRING =
  "Sorry, something went wrong when trying to think of a response. Please try again! 🙏";
...
export const addContextToPrompt = (userID: string) => {
  const context = `The user you are talking to can be pinged with <@${userID}>. Consider using this to get their attention or to address them directly like you would naturally in a conversation.`;
